 ...
 * @author NAM
 */
public class EditGuruForm extends javax.swing.JFrame {
    Connection conn;

    /**
     * Creates new form EditGuruForm
     */
    public EditGuruForm() {
        initComponents();
    ...
    public void setData(String id, String nama, String telepon, String alamat) {

        txtIdGuru.setText(id);
        txtNamaGuru.setText(nama);
        txtNoTelepon.setText(telepon);
        txtAlamat.setText(alamat);

        txtIdGuru.setEditable(false);
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("EDIT DATA GURU");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String sql = "UPDATE guru SET nama_guru=?, no_telp=?, alamat=? WHERE id_guru=?";

        PreparedStatement ps = conn.prepareStatement(sql);

        ps.setString(1, txtNamaGuru.getText());
        ps.setString(2, txtNoTelepon.getText());
        ps.setString(3, txtAlamat.getText());
        ps.setString(4, txtIdGuru.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditGuruForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditGuruForm().setVisible(true);
            }
        });
    }
